...
const SiteWebHosting = () => {
	document.title = "Site Setting: Web Hosting | Admin & Dashboard";
	...
	useEffect(() => {
		dispatch(getSiteSetting("WEB_HOSTING"));
		return () => {
...
export default withRouter(SiteWebHosting);
